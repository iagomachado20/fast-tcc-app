...
import { Image, ImageBackground, StyleSheet, SafeAreaView, ActivityIndicator } from 'react-native';
import styled from 'styled-components';
import { LinkFooter, LinkInline, TextInlineWhite, ValidationField, LinkText } from '../styles/style';
import { Button, Text, Item, Input, Label, View, StyleProvider, Toast } from 'native-base';
